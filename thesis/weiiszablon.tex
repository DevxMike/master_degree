...
Na niżej ukazanych obrazkach przedstawiono wyniki działania algorytmów przeszukiwania grafu dla pięciu iteracji. Każdy zestaw obrazków składa się z dwóch głównych sekcji: mapy ogólnej, porównania ścieżek dla algorytmów A* z różnymi heurystykami oraz algorytmu Dijkstry.
...
\bibitem{PID} https://pl.wikipedia.org/wiki/Regulator\_PID

\bibitem{DIJKSTRA} http://algorytmy.ency.pl/artykul/algorytm\_dijkstry

\bibitem{ASTAR} https://pl.wikipedia.org/wiki/Algorytm\_A*

\bibitem{DSTAR} https://en.wikipedia.org/wiki/D*

\bibitem{DSTARLITE} https://en.wikipedia.org/wiki/D*\#D*\_Lite

\bibitem{ZIEGLER} https://en.wikipedia.org/wiki/Ziegler\%E2\%80\%93Nichols\_method
