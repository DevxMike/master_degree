...
plt.plot(iterations, astar_manhattan_times, label='A* Manhattan', marker='o')
plt.plot(iterations, astar_euclidean_times, label='A* Euclidean', marker='o')
plt.plot(iterations, astar_max_times, label='A* Max', marker='o')
plt.plot(iterations, dijkstra_times, label='Dijkstra', marker='o')
plt.xlabel('Iteracja')
